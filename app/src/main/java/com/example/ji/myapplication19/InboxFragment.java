...
import com.example.ji.myapplication19.C;
import com.example.ji.myapplication19.R;

/**
 * Created by Ji on 16/2/20.
 */
public class InboxFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.activity_new__request, container, false);

        ((C) getActivity()).getSupportActionBar().setTitle("Fragment Inbox");
